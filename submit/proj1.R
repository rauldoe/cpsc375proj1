...
comboNChooseKAllv3 <- function(inputList, minK, k, processComboListFunc, pclInfo) {
...
if (doGenerateCombo) {
  ...
  comboNChooseKAllv3(as.list(allIVars), minK, k, processComboListFunc, pclInfo)
}
